...
function App() {
  return (
    <div className='App'>
      <div className='bg-main-bg min-h-screen w-full py-10 px-4'>
        <div className='max-w-1080 max-w-container w-full bg-white mx-auto rounded-2xl py-4'>
          <header className='flex justify-between border-b-2 border-gray-300 px-14 pb-4 md:px-4'>
            ...
            <div className='flex items-center'>
              <ul className='flex'>
                <li className='flex'>
                  ...
                  <b className='text-sm font-semibold text-gray-600 ml-1'>
                    1205 руб.
                  </b>
                </li>
                <li className='mx-7 md:mx-4'>
                  <svg
                    width='22'
                    height='19'
                    viewBox='0 0 22 19'
          ...
          {/* mb-4 ${styles.search} -gray-500border2""""''*/}
          <main className='px-14 pt-4 w-full md:px-4'>
            <div className='mb-6 flex justify-between items-center sm:flex-col'>
              <h2 className='font-bold text-3xl sm:mb-2'>Все кроссивки</h2>
              <div className='relative sm:w-full'>
                ...
                />
                <input
                  className={`search border px-2 py-1 pl-7  rounded-lg text-sm sm:w-full `}
                  placeholder='Поиск...'
                  type='text'
                />
              </div>
